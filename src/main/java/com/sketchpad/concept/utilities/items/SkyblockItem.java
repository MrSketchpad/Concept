...
public class SkyblockItem {
    ...
    Reforge reforge = new Reforge(SkyblockStats.getEmpty(), SkyblockStats.getEmpty(), ItemType.ALL, "", 0, Rarity.COMMON, Material.STONE,
    ...
    public @NotNull ItemStack toItemStack() {
        ...
        if (!enchants.getActive().isEmpty()){
            ...
            if (enchants.enchants.containsKey(Enchant.KNOCKBACK)) {
    ...
    SkyblockItem fromItemStack(@NotNull ItemStack i) {
        ...
        Reforge reforge = new Reforge(SkyblockStats.getEmpty(), SkyblockStats.getEmpty(), ItemType.ALL, "", 0, Rarity.COMMON,
